...
{
    public class FaixaVolume : Entidade<FaixaVolume>
    {
        public FaixaVolume()
        {
        ...
        public FaixaVolume(int layoutId, decimal valorInicial, decimal valorFinal, decimal preco)
        {
            LayoutId = layoutId;
        ...
        public void Alterar(FaixaVolume faixaPeso)
        {
