...
namespace WsConsultaSPC
{
    public class LimiteCreditoSpcDTO
    {
        ...
        public StatusLimiteCreditoResponse StatusLimiteCredito { get; set; }
    }
    ...
    public class ConsultaSpcResponse
    {
        public int Id { get; set; }

        public StatusAnaliseDeCreditoResponse StatusAnaliseDeCredito { get; set; }
        ...
        public TipoPessoaResponse TipoPessoa { get; set; }
