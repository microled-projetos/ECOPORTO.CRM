...
(function ($) {
    ...
    function TagsInput(element, options) {
        ...
        if (!this.isTextArea) {
            ...
            this.$container = $('<div class="bootstrap-tagsinput bootstrap-tagsinput-textarea"></div>');
        }
        
        this.$input = $('<input type="text" class="controle-input-tags" readonly/>').appendTo(this.$container);
