...
{
    public class CanActivateUsuarioIntegracaoAdendo : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            {
                context.Controller.ViewBag.HabilitaBotaoIntegracaoAdendo = false;
            }
            else
            {
                if (HttpContext.Current.User.IsInRole("BaseDesenvolvimento"))
                {
                    context.Controller.ViewBag.HabilitaBotaoIntegracaoAdendo = parametros.IntegraChronos && usuarioIntegracao != null;
                }
                else
                {
                    if (usuarioIntegracao != null)
                    {
                        context.Controller.ViewBag.HabilitaBotaoIntegracaoAdendo = parametros.IntegraChronos && usuarioIntegracao.AcessoProducao;
                    }
                }
            }            
        }
